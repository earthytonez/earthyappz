...
const JsonContext = ({ children  })=>{
    const state = {
        themes: themes_namespaceObject,
        resources: resources_namespaceObject
    };
    return /*#__PURE__*/ jsx_runtime_.jsx(FilterContext.Provider, {
        value: state,
        children: children
    });
};
...
const App = ({ Component , pageProps  })=>{
    ...
    const { 0: fontcss , 1: setFontcss  } = (0,external_react_.useState)();
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(JsonContext, {
        children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [626], () => (__webpack_exec__(322)));
